...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " cheesecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  cheesecoin-tx [options] <hex-tx> [commands]  Update hex-encoded cheesecoin transaction\n" +
            "or:     cheesecoin-tx [options] -create [commands]   Create hex-encoded cheesecoin transaction\n" +
            "\n";
