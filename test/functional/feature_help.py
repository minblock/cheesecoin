...
"""Verify that starting cheesecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cheesecoin with -h for help text")
        ...
        self.log.info("Start cheesecoin with -version for version information")
        ...
        self.log.info("Start cheesecoind with -fakearg to make sure it does not start")
