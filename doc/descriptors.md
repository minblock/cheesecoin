# Support for Output Descriptors in cheesecoin Core

Since cheesecoin Core v0.17, there is support for Output Descriptors. This is a
...
on cheesecoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing cheesecoin Core wallets, a convenience function `combo` is
