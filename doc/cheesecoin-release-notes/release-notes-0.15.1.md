cheesecoin Core version *0.15.1* is now available from:

  <https://download.cheesecoin.org/cheesecoin-0.15.1/>
...
A number of changes to the way cheesecoin Core deals with peer connections and invalid blocks
